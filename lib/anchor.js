...
export function statusLabel(status) {
  return {
    ...
    'schema-not-found': 'schema file not found in any synced repo',
    'fields-missing': 'declared fields absent from the schema',
    'fields-malformed': 'the contract\'s fields are not a list',
    unreachable: 'its repo could not be fetched',
    'repo-unregistered': 'its repo is not in the registry',
  }[status] ?? status
}
